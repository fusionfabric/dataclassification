...
class LogGenerator:
    ...
    def WriteProductLog(self,unclassified_technical_fields,all_fields):
        ...
        if len(unclassified_technical_fields) > 0:
            print("##vso[task.logissue type=warning;]Unclassified technical fields: {}".format(unclassified_technical_fields))
            ...
            self.statisticslog.append([self.product,'All-APIs',round(percentage,1),total_fields,classified_fields,unclassified_fields])
