...
class SwaggerClassifier:
    ...
    def __init__(self, swagger_folder_path, classification_header, encryption_header, maturity_status,
                 parameter_exclusion_list, rules_file_path, filenames, tags_list):
        for handler in logging.root.handlers[:]:
            logging.root.removeHandler(handler)
        logging.basicConfig(filename=swagger_folder_path + '/data-classification.log',
